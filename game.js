...
window.addEventListener("keydown", (event) => {
  ...
  if (!gameStarted) {
    if (["ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight", "Space", "KeyE", "KeyF", "KeyC", "KeyM", "KeyR", "Escape", "Digit1", "Digit2", "Digit3", "Digit4", "Digit5"].includes(code)) {
...
function handleMainMenuClick(mouseX, mouseY) {
  ...
  if (mainMenuScreen === MENU_MODE) {
    ...
    if (pointInRect(mouseX, mouseY, inputState.mainMenu.multiplayerButton)) {
      setMenuStatus("Multiplayer coming soon.");
      return;
    }
